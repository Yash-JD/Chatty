      ...
      return res
        ...
        .json(
          createErrorResponse(
            ...
            AuthMessages.ALL_FIELDS_REQUIRED,
          ),
        );
    }
    ...
    if (password.length < 6) {
      return res
        ...
        .json(
          createErrorResponse(
            StatusCodes.BAD_REQUEST,
            AuthMessages.PASSWORD_MIN_LENGTH,
          ),
        );
    }
    ...
    if (error.code === FirebaseMessages.EMAIL_ALREADY_IN_USE) {
      return res
        ...
        .json(
          createErrorResponse(
            StatusCodes.BAD_REQUEST,
            AuthMessages.EMAIL_EXISTS_FIREBASE,
          ),
        );
    }
    res
    ...
    if (!firebaseUid) {
      return res
        ...
        .json(
          createErrorResponse(
            StatusCodes.BAD_REQUEST,
            AuthMessages.FIREBASE_UID_REQUIRED,
          ),
        );
    }
...
export const logout = async (req, res) => {
  try {
    ...
    res
      ...
      .json(createSuccessResponse(AuthMessages.LOGOUT_SUCCESS));
  } catch (error) {
    ...
    if (!profilePic) {
      return res
        ...
        .json(
          createErrorResponse(
            StatusCodes.BAD_REQUEST,
            AuthMessages.PROFILE_PIC_REQUIRED,
          ),
        );
    }
